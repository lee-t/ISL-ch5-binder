...
```{r auto_poly_fits_validation_10}
auto_poly_fits_validation_10 <- bind_rows(
...
p2 <- auto_poly_fits_validation_10 %>%
...
p1 <- p2 %+% filter(auto_poly_fits_validation_10, rep == "1") +
...
These estimates are similar, but wouldn't be considered close.
